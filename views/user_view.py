...
class InventoryUsuarios(QMainWindow):
    ...
    def create_left_panel(self, layout):
        ...
        """)
        menu_button.clicked.connect(self.return_to_login) 
        ...
        image_label = QLabel()
        pixmap = QPixmap("images/model_icons/admin.png")  
    ...
    def search_user(self):
        ...
        users = self.crud.search_user(username) 
    ...
    def edit_user(self):
        ...
        if self.crud.update_user(user_id, username, password):  
